...
class GLCameraScreen extends React.Component<{}, State> {
  ...
  toggleFilter = () => {
    // console.log('aaaaacaca ', this.contextRef.shaderSource(this.contextRef.frag, fragShaderSource););
    // GL.GLView.createContextAsync().then(this.onContextCreate);
  ...
  onContextCreate = async (gl: GL.ExpoWebGLRenderingContext) => {
    ...
    console.log('wwww ', this.state.warm);
